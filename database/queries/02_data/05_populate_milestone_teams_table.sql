...
--              ('Rival Battle', 'charmander', 1, 5, TRUE, ARRAY['tackle', 'growl'],'bulbasaur'),
--              -- First Rival Battle - If Player Chose Squirtle
--              ('Rival Battle', 'bulbasaur', 1, 5, TRUE, ARRAY['tackle', 'growl'],'squirtle'),
--              -- First Rival Battle - If Player Chose Charmander
--              ('Rival Battle', 'squirtle', 1, 5, TRUE, ARRAY['tackle', 'tail-whip'],'charmander'),
--              
--              ('Bug Catcher', 'weedle', 1, 6, FALSE, ARRAY['poison-sting', 'string-shot'],NULL),
--              
--              -- Gym 1: Brock
