...
- [Database Diagram](Database-Diagram.svg) - Created using [mermaid](https://mermaid.ai/). Contains the database schema along with a description of the tables. **V.1.0.1**
